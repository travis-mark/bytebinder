defmodule BytebinderWeb.CoreComponents do
  @moduledoc """
  ...
  def modal(assigns) do
    ...
    >
      <div id={"#{@id}-bg"} class="bg1-50o fixed inset-0 transition-opacity" aria-hidden="true" />
      <div
        ...
        <div class="flex min-h-full items-center justify-center">
          <div class="w-full max-w-3xl p-4 sm:p-6 lg:py-8">
            <.focus_wrap
              ...
              class="shadow-zinc-700/10 ring-zinc-700/10 relative hidden rounded-2xl bg1 p-14 shadow-lg ring-1 transition"
            >
  ...
  def button(assigns) do
    if assigns.href do
      ...
      <a
        href={@href}
        class={[
          "button phx-submit-loading:opacity-75 rounded-lg py-2 px-3",
  ...
  def input(%{type: "select"} = assigns) do
    ...
    <div phx-feedback-for={@name}>
      ...
      <select
        ...
        name={@name}
        class={[
          "block w-full rounded-md border shadow-sm focus:ring-0 sm:text-sm",
  ...
  def input(%{type: "textarea"} = assigns) do
    ...
    <div phx-feedback-for={@name}>
      ...
      <textarea
        ...
        name={@name}
        class={[
          "block w-full rounded-lg focus:ring-0 sm:text-sm sm:leading-6",
  ...
  def header(assigns) do
    ...
    <header class={[@actions != [] && "flex items-center justify-between gap-6", @class]}>
      ...
      <div class="flex flex-row gap-2 items-center"><%= render_slot(@actions) %></div>
    </header>
    """
  end
  ...
  def table(assigns) do
    ...
    <div class="overflow-y-auto px-4 sm:overflow-visible sm:px-0">
      <table class="w-[40rem] mt-4 sm:w-full">
        <thead class="text-sm text-left gap-6 font-bold">
          <tr>
            <th :for={col <- @col} class="p-0 pr-6 pb-4"><%= col[:label] %></th>
        ...
        <tbody
          ...
          class="relative divide-y divide-zinc-100 border-t border-zinc-200 text-sm gap-6"
        >
          <tr :for={row <- @rows} id={@row_id && @row_id.(row)} class="group">
            ...
            >
              <div class="block min-h-[50px] flex items-center">
            ...
            <td :if={@action != []} class="relative w-14 p-0">
              <div class="relative whitespace-nowrap py-4 text-right text-sm font-medium">
                ...
                <span
                  :for={action <- @action}
                  class="relative ml-4 font-semibold leading-6 link"
                >
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BytebinderWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BytebinderWeb.Gettext, "errors", msg, opts)
    end
  end
